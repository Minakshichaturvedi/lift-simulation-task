...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function startSimulation(floorCount, liftCount) {
        ...
        // Create lifts || random image will be generated
        // List of lift images
const liftImages = [
    "images/WhatsApp Image 2024-12-11 at 17.17.40_d152feb3.jpg",
    "images/8747768b-6d65-4b82-89b6-b3ccc97afaab.png",
    "images/WhatsApp Image 2024-12-11 at 17.17.41_5ad4f11c.jpg",
    "images/WhatsApp Image 2024-12-11 at 17.17.41_761a4a70.jpg",
    "images/WhatsApp Image 2024-12-11 at 17.17.42_e7c9ccd3.jpg"
];
...
for (let j = 0; j < liftCount; j++) {
    ...
    const randomImg = liftImages[Math.floor(Math.random() * liftImages.length)];
    lift.style.backgroundImage = `url('${randomImg}')`;
    lift.style.backgroundSize = "cover";
    lift.style.backgroundPosition = "center";
